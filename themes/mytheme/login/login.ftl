...
<@layout.registrationLayout displayInfo=(realm.password && realm.registrationAllowed && !registrationDisabled??) displayMessage=!messagesPerField.existsError('username','password'); section>
    ...
    <#elseif section = "form">
        <div id="kc-form" class="custom-form">
                ...
                <#if realm.password>
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                        ...
                        <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                            ...
                            <input tabindex="4" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} custom-button"
    ...
    <#elseif section = "info">
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
            <div id="kc-registration-container" class="custom-registration">
